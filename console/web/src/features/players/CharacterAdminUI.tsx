...
import { ItemCatalogSelector, ItemGradeSelect, PackageItemPreview, buildingSubCategory, catalogItemId, catalogItemMinimumGrade, catalogItemName, grantItemDurability, itemGrade, normalizeItemGrade, type CatalogItem } from "../../components/common/ItemCatalog";
import { placeableRecipeKey, PLACEABLE_RESOURCES, resourceTemplateId } from "../../data/placeableResources";
