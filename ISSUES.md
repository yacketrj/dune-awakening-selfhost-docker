...
- **Progress**:
  - ✅ BlueprintsPanel — import/export with multi-select, integrated into Player tab
  - ✅ Fixed readMultipartForm, player_id insert, PlayerBaseBackupId in stats
  - ⬜ In-game preview testing (P34 crash investigation)
  - ⬜ Upstream PR
